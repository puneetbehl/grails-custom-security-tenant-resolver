...
[source,groovy]
.src/integration-test/groovy/demo/CurrentUserResolverSpec.groovy
----
include::{sourceDir}/../complete-currentuser/src/integration-test/groovy/demo/CurrentUserResolverSpec.groovy[]
----
